...
export default function HomePage() {
  ...
  return (
    ...
    style={{background: "linear-gradient(to bottom right, #FF6600, #FF6666, #ffffff)",}}>
      <div className="bg-white/90 backdrop-blur-md p-10 rounded-3xl shadow-2xl max-w-xl w-full space-y-8 border border-orange-200">
